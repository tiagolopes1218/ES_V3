...
const Login = () => {
  ...
  const handleNavigateToEmployeeLogin = () => {
  ...
  return (
    <div style={{ textAlign: "center", padding: "20px" }}>
      ...
      {/* Botão para a Página de Login de Funcionários */}
      <button
        onClick={handleNavigateToEmployeeLogin}
        style={{
          padding: "10px 20px",
          ...
          borderRadius: "5px",
          cursor: "pointer",
          marginTop: "20px", // Adiciona espaço entre o botão e o botão anterior
        }}
      >
        Página de Login de Funcionários
      </button>
    </div>
  );
};
